...
module.exports = {
  ...
  testMatch: ['**/backend-performance.test.ts', '**/native-backend-performance.test.ts', '**/pool-contention-proof.test.ts', '**/native-mapepire-pool.test.ts', '**/remote-mapepire-pool.test.ts', '**/remote-mapepire-multiplex.test.ts'],
